...
export const MAX_FMD_SIZE = (FMD_SIZE.DPFJ_FMD_ANSI_378_2004_RECORD_HEADER_LENGTH + FMD_SIZE.DPFJ_FMD_ANSI_ISO_VIEW_HEADER_LENGTH + 255 * FMD_SIZE.DPFJ_FMD_ANSI_ISO_MINITIA_LENGTH + 2);